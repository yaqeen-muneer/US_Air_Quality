...
The project was developed to end my Data Analytics Bootcamp Journey as my **Capstone Presentation** and is designed to communicate complex environmental data in a clear, engaging, and educational format.

---

## Objectives
- Quantify changes in U.S. AQI from 2019–2023.
- Identify **seasonal, hourly, and geographic variations** in pollutant concentrations and AQI.
- Explain scientific reasoning of trends like **tropospheric ozone formation** and **tempreature inversion lid**.
- Compare U.S. and Indian air quality trends, linking them to **energy generation** and other factors.
- Provide **policy and energy recommendations** for improving air quality in the U.S.

---

## Data Sources
- **U.S. EPA**: AQI and pollutant concentration datasets.  
- **Indian CPCB**: AQI and pollutant concentration datasets.  
- **Energy Statistics (EMPER ENERGY)**: Fossil fuel electricity generation (2000–2024).  
- **Temperature Records (NCEI)**: daily averages.  
